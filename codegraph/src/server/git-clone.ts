 ...
 * Git Clone Utility
 *
 * Shallow-clones repositories into the codegraph clones cache.
...
/**
 * Get the clone target directory for a repo name. Lives under
 * `<globalDir>/repos/<name>` so it sits next to the registry and benefits
 * from the same legacy-fallback path resolution.
 */
