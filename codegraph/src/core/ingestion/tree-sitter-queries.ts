...
; Switch-case constant references: case pkg.Const:
(expression_case
  value: (expression_list
    (selector_expression
      operand: (identifier) @switch_case.receiver
      field: (field_identifier) @switch_case.name))) @switch_case

; Switch-case bare constant: case LocalConst:
(expression_case
  value: (expression_list
    (identifier) @switch_case.name)) @switch_case
`;
