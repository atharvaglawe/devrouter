 ...
 */
async function findGroupsContainingRegistryName(_registryName: string): Promise<string[]> {
  // Cross-repo group support stripped from devrouter-vendored gitnexus.
  // Always return empty so the AGENTS.md/CLAUDE.md "Cross-Repo Groups" section is omitted.
  return [];
}
